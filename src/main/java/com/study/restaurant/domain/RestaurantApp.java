package com.study.restaurant.domain;

import com.study.restaurant.mcrsrvc.domain.model.Restaurant;
import com.study.restaurant.mcrsrvc.domain.model.Table;
import com.study.restaurant.mcrsrvc.domain.service.RestaurantService;
import com.study.restaurant.mcrsrvc.persistence.InMenRestaurantRepository;
...
public class RestaurantApp {
    ...
    public static void main(String[] args) {
        try {
            ...
            RestaurantService restaurantService = new RestaurantService(new InMenRestaurantRepository());
